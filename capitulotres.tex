...
Para la configuraci\'on de las tareas, se tom\'o el tamaño con un intervalo de 1 kb a 1024 kb de acuerdo al tamaño mínimo y máximo en el ERP \textit{Odoo},  el par\'ametro \textit{fileSize}, que representa el tamaño del archivo de entrada, va de 1 kb a 1024 kb as\'i como el archivo de salida, como par\'ametro final se tiene los \textit{MIPS} que ir\'an de 1 a 3 (Cuadro \ref{tab:cloudlet}).
...
\begin{figure}[h!] 
	\centering
	\includegraphics[scale=0.6]{media/tiempoejecucion}

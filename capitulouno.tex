...
\addcontentsline{toc}{subsection}{Tiempo de ejecución}
...
\subsection*{Costo de procesamiento}
\addcontentsline{toc}{subsection}{Costo de procesamiento}

Costo o esfuerzo que utiliza una máquina virtual para ejecutar una tarea (\cite{redhat}). 

\subsection*{Definición de Simulación}
\addcontentsline{toc}{subsection}{Definición de Simulación}
...
Las definiciones anteriores especifican los elementos que se tratarán en la implementación de éste proyecto tales como; el modelo del centro de datos, los modelos matemáticos que en este caso serán los algoritmos de calendarización. Con el fin de entender y evaluar el comportamiento de un sistema ERP bajo un algoritmo propuesto. 
\newpage
